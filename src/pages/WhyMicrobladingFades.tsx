  ...
  return (
    <>
      <SEO
        ...
        description="Expert analysis of why microblading fades — pigment oxidation, oily skin, humidity, UV exposure, and how the DMV climate accelerates fading. Data from hundreds of procedures. Learn what lasts longer. Ink Mugi, Annandale VA."
        ...
        <div className="container-custom">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-sm text-[#2D2D2B]/60 max-w-2xl mx-auto mb-8">
              By a Virginia-licensed PMU artist with hundreds of procedures • Includes DMV-specific climate data
            </p>
