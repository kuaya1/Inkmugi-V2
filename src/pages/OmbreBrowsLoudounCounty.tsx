  ...
  return (
    <>
      ...
      <LocationHero
        ...
        subtext="Precision permanent makeup for Ashburn, Leesburg, Sterling, and South Riding residents — performed at our VA-licensed Annandale studio with hundreds of documented procedures and healed-result verification at six weeks."
        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              ...
              { icon: Shield, title: 'The first pass is deliberately light', desc: 'hundreds of documented procedures. Rigorous technique and candidacy screening.' },
      ...
      <LocationMidCTA
        subtext="Ashburn, Leesburg, and Sterling residents trust Ink Mugi for precision ombré brows — VA-licensed with hundreds of documented procedures."
      />
