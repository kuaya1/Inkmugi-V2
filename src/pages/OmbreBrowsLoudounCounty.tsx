        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="text-center mb-8">
            ...
            <p className="text-lg md:text-xl text-[#2D2D2B]/75 max-w-3xl mx-auto mb-4 leading-relaxed">
              Precision permanent makeup for Ashburn, Leesburg, Sterling, and South Riding residents — performed at our VA-licensed Annandale studio with 523+ documented procedures and healed-result verification at six weeks.
            </p>
