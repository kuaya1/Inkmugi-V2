...
const OmbreBrowsManassas: React.FC = () => {
  const localSchema = {
    ...
    "url": "https://inkmugi.com/ombre-brows-manassas-va",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Ombre Brows Manassas VA", "item": "https://inkmugi.com/ombre-brows-manassas-va" }
            ]
          })}
        </script>
      </SEO>
