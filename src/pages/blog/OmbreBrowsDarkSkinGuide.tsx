...
const OmbreBrowsDarkSkinGuide: React.FC = () => {
  ...
  const articleSchema = {
    ...
    "description": "Expert guide on ombre powder brows for Fitzpatrick skin types IV–VI. Covers pigment selection, healing differences, keloid considerations, and before/after examples from hundreds of procedures.",
    "author": {
      "@type": "Person",
          ...
          <AnimatedSection className="mt-16">
            <div className="bg-[#F7EDE6] rounded-2xl p-8">
              ...
              <div className="prose prose-lg text-[#2D2D2B]/85 max-w-none">
                ...
                <p>
                  We track every outcome, and complications have been rare. We put that down to screening carefully, working conservatively, and staying reachable while you heal.
                </p>
                <p>
