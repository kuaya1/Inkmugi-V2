...
const PermanentMakeupBurke: React.FC = () => {
  return (
    <LocationPage
      ...
      seoDescription="Professional ombre powder brows for Burke, VA residents. VA-licensed, hundreds of documented procedures, 0.19% complication rate. Just 12 minutes from Burke Centre. $600 all-inclusive. Free consultation."
      ...
      heroSubtext="Ombré powder brows for Burke families and professionals. hundreds of documented procedures with a 0.19% complication rate — see the shape on your face and approve before any pigment."
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "Burke clients consistently choose us after comparing healed results online. With hundreds of documented procedures and a 0.19% complication rate, our track record is verifiable. The $600 all-inclusive price (compared to $800+ at DC and Tysons studios), combined with our design-approval process where you see the exact shape on your face before any pigment, gives Burke families the confidence they need.",
        },
        {
