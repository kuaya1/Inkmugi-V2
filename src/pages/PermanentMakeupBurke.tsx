...
const PermanentMakeupBurke: React.FC = () => {
  return (
    <LocationPage
      ...
      seoDescription="Professional ombre powder brows for Burke, VA residents. VA-licensed, hundreds of documented procedures, tracked outcomes. Just 12 minutes from Burke Centre. $600 all-inclusive. Free consultation."
      ...
      heroSubtext="Ombré powder brows for Burke families and professionals. Hundreds of documented procedures — see the shape on your face and approve before any pigment."
