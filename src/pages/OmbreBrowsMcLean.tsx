...
const OmbreBrowsMcLean: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container-custom">
          <AnimatedSection className="max-w-3xl mx-auto mb-16">
            ...
            <div className="space-y-5 text-[#2D2D2B]/75 leading-relaxed">
              ...
              <p>
                Ombré powder brows use a precision stippling technique that deposits pigment beneath the skin surface in fine, layered dots. Unlike microblading — which creates shallow incisions that blur and fade quickly in humid climates — the powder method produces a soft, graduated density that holds its form through Northern Virginia's seasonal shifts. Our data from hundreds of procedures shows an average retention of 24 months, compared to 8–12 months for microblading in similar DMV-area clients.
              </p>
              <p>
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-4">
                {[
                  ...
                  { icon: Shield, title: 'The first pass is deliberately light', desc: 'Across hundreds of documented procedures. Rigorous technique, proper screening, and comprehensive aftercare.' },
      ...
      <section className="py-20 bg-[#F9F7F5]">
        <div className="container-custom">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-sm text-[#2D2D2B]/60">5.0 average across what clients say</p>
          </AnimatedSection>
      ...
      <LocationMidCTA
        subtext="McLean and Great Falls clients trust Ink Mugi for precision ombré brows — VA-licensed, hundreds of documented procedures, just 15 minutes away."
      />
