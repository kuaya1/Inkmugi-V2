...
const TermsOfService: React.FC = () => {
  return (
    <>
      <SEO
        title="Terms of Service | Ink Mugi"
        description="Terms of service for Ink Mugi permanent makeup studio. Review our policies on appointments, cancellations, aftercare responsibilities, and service agreements."
