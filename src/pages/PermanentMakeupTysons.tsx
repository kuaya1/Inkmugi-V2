...
const PermanentMakeupTysons: React.FC = () => {
  const localSchema = {
    ...
    "name": "Ink Mugi",
    "url": "https://inkmugi.com/permanent-makeup-tysons-va",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Permanent Makeup Tysons VA", "item": "https://inkmugi.com/permanent-makeup-tysons-va" }
            ]
          })}
        </script>
      </SEO>
