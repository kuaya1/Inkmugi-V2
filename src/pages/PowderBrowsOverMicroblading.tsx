    ...
    <>
      ...
      >
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://www.inkmugi.com/powder-brows-over-microblading",
            "mainEntityOfPage": "https://www.inkmugi.com/powder-brows-over-microblading"
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Powder Brows Over Microblading", "item": "https://www.inkmugi.com/powder-brows-over-microblading" }
            ]
          })}
        </script>
      </SEO>
      ...
      <section className="py-20 bg-[#F9F7F5]">
        <div className="container-custom max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { to: '/microblading-correction-northern-virginia', icon: Shield, title: 'Microblading Correction', desc: 'Full details on our correction services — process, pricing, and booking in Annandale, VA.' },
              { to: '/why-microblading-fades', icon: Clock, title: 'Why Microblading Fades', desc: 'The 6 biological and environmental factors behind premature microblading fading.' },
              { to: '/microblading-for-oily-skin', icon: Droplets, title: 'Microblading & Oily Skin', desc: 'Why oily skin causes microblading failure and why powder brows perform 340% better.' },
            ].map((link, idx) => (
