      ...
      >
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://inkmugi.com/microblading-fading-too-fast",
            "mainEntityOfPage": "https://inkmugi.com/microblading-fading-too-fast"
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Microblading Fading Too Fast", "item": "https://inkmugi.com/microblading-fading-too-fast" }
            ]
          })}
        </script>
      </SEO>
