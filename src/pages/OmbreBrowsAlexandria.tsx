  ...
  return (
    <>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Ombre Brows Alexandria VA", "item": "https://inkmugi.com/ombre-brows-alexandria-va" }
            ]
          })}
        </script>
      </SEO>
      ...
      <LocationHero
        ...
        subtext="Just 15 minutes from Old Town & Del Ray. Northern Virginia's most trusted PMU artist with 330+ successful procedures and premium results."
