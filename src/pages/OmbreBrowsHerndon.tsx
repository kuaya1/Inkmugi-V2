...
const OmbreBrowsHerndon: React.FC = () => {
  const localSchema = {
    ...
    "url": "https://www.inkmugi.com/ombre-brows-herndon-va",
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Ombre Brows Herndon VA", "item": "https://www.inkmugi.com/ombre-brows-herndon-va" }
            ]
          })}
        </script>
      </SEO>
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="text-center mb-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-cormorant font-medium mb-6 text-[#2D2D2B] leading-tight">
              ...
              <span className="text-[#9A7B69]">Herndon, VA</span>
            </h1>
            <p className="text-lg md:text-xl text-[#2D2D2B]/80 max-w-3xl mx-auto mb-4">
              Healed-first permanent makeup trusted by Herndon professionals. 330+ documented procedures with a 0.19% complication rate — see the shape on your face and approve before any pigment.
            </p>
            <p className="text-base text-[#2D2D2B]/60 max-w-2xl mx-auto mb-8">
              30 minutes from Downtown Herndon to our private Annandale studio. Free parking. Consultation-first approach.
            </p>
