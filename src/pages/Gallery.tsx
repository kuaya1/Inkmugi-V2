  ...
  return (
    <>
      ...
      >
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Healed ombre powder brows results from hundreds of procedures at Ink Mugi in Annandale, VA.",
      ...
      <section className="py-20 bg-[#F9F7F5]">
        <div className="container-custom">
          <AnimatedSection className="text-center mb-12">
            <h2 className="section-title text-[#2D2D2B]">From the studio</h2>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedSection>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-cormorant font-medium mb-6 leading-tight">
                Want to talk through your own brows?
              </h2>
