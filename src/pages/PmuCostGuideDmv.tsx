        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              and the hidden fees most studios don't mention. Based on market research and hundreds of procedures.
            </p>
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">
                  hundreds of procedures means efficiency through experience. I don't need 4 hours for what
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            ...
            <div className="flex items-center gap-2 text-amber-900">
              ...
              <span className="text-sm font-medium">The first pass is deliberately light</span>
            </div>
            <div className="flex items-center gap-2 text-amber-900">
              <BarChart3 className="w-5 h-5 text-amber-700" />
              <span className="text-sm font-medium">hundreds of procedures</span>
            </div>
          </div>
        </div>
      </section>
